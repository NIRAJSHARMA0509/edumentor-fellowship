...
const testimonials = [
  ...
  },
  {
    ...
    quote: "As someone from a non-technical background, Pillar II was a revelation. Professor Narayan's approach to explaining complex AI concepts without requiring coding skills was brilliant. I now confidently engage with technical teams at work and have implemented several AI-driven solutions in my research.",
    rating: 5,
    avatar: "MS"
  }
];
      ...
      <div className="container">
        <div className="text-center max-w-3xl mx-auto mb-16">
          ...
          <p className="text-lg text-muted-foreground font-body">
            ...
            highlighting the programme's transformative impact.
          </p>
        </div>
